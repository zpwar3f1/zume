...
PDF for printing and sending; DOCX for editing. Placeholders are shown in orange square brackets: company address, contact details, signatory, payment details, and the bracketed amounts in the agreement (vehicle allocation window, non-circumvention fee, insurance). Have a BC lawyer review the agreement before first use.
